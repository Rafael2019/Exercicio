            ...
            switch (esc) {
                ...
                case 3: {
                    ...
                    do {
                        ...
                        matricula = Integer.parseInt(JOptionPane.showInputDialog("Informe sua matricula: "));
                        dataNascimento = sdf.parse(JOptionPane.showInputDialog("informe sua data de nascimento"));
                        dataMatricula = sdf.parse(JOptionPane.showInputDialog("informe a data da matricula "));
                        Aluno.add(new Aluno(matricula, dataNascimento, nome, cpf, rg, idade, dataMatricula));
